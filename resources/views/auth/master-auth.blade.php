...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('auth/') }}" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('auth/img/favicon/favicon.ico') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('auth/vendor/fonts/boxicons.css') }}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('auth/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('auth/vendor/css/theme-default.css') }}"
